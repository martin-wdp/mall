...
public class GoodsBrandMapperImpl extends BasicSqlSupport implements
    ...
    public List<GoodsBrand> queryAllGoodsBrandBy_PL() {
        return this
                .selectList("com.ningpai.goods.dao.GoodsBrandMapper.queryAllGoodsBrandBy_PL");
    }
    /**
     * 根据品牌类型查询商品品牌
     * ADD BY LY 15-11-05
    ...
    public List<GoodsBrand> queryGoodsBrand(Map<String, Object> param) {
        return this.selectList("com.ningpai.goods.dao.GoodsBrandMapper.queryGoodsBrand",param);
    }
