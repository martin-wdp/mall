 ...
 * @version V1.0
 */
@Repository("InfoSysTempDao")
public class InfoSysTempDaoImpl extends BasicSqlSupport implements InfoSysTempDao {
     ...
     * @since 2014-03-29 17:43:53
     */
    public final List<Object> querySysTempByPagenew(final Map<String, Object> parameter) {
        return this.selectList("com.ningpai.temp.dao.SysTempDaoImpl.querySysTempByPage", parameter);
    }
}
