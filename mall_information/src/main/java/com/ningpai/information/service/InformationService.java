...
public interface InformationService {
     ...
     * @return
     */
    PageBean queryByPageBean(PageBean pb, SelectBean selectBean, Long typeId);
     ...
     * @return
     */
    boolean checkAddInfoByTitle(String title);
     ...
     * @return
     */
    boolean checkAddInfoByTitle(String title, Long infoId);
     ...
     * @return
     */
    PageBean queryByPageBeanForSite(PageBean pb, SelectBean selectBean, Long typeId);
     ...
     * @return
     */
    PageBean queryByPageBeanForMobSite(PageBean pb, SelectBean selectBean, Long typeId);
}
