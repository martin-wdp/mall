...
.main_cont {height:auto!important;}
  ...
  <body>
   <input name="basePath" id="basePath" value="<%=basePath%>" type="hidden"/>
     <!-- 引用头 -->
								...
								<div class="form_group fg_box nlink-wp clearfix">
									...
									<div class="form_cont dd-box">
										...
										<div class="lk-sel lk-chs"><span class="sel-word"></span><ul><li class="s-selected"><a data-href="lk-01">功能链接</a></li><li><a data-href="lk-02">自定义链接</a></li></ul></div>
						      		  	...
						      		  	<li><a data-href="choose">分类/商品</a></li>
...
<jsp:include page="../../mobile_home_page/inner_join.jsp"></jsp:include>
<jsp:include page="../../mobile_home_page/music_join.jsp"></jsp:include>
...
$(function(){
  ...
  $('.cube').rightclick(function(){
	...
	$("#rollAdvChoose").click(function(){
		...
		if(num>0){
			art.dialog.open('<%=basePath%>queryImageManageByPbAndCidForChoose.htm?CSRFToken=${token}&size='+num, {
				id: 'rollAdv',
				lock: true,
				width: '800px',
				height: '400px',
...
$("#choooseProduct").button().click(function (){
	 ...
	 //计算可选择的商品
	 art.dialog.open('<%=basePath%>queryMobProductForGoods.htm?CSRFToken=${token}&size='+size, {
			lock: true,
			width: '800px',
		    height: '400px',
			title: '选择图片'
