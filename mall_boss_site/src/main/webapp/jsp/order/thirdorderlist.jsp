              ...
              <table class="table order_table">
                ...
                <tr class="data1 status">
                  ...
                  <td align="center">
                      ...
                      <c:if test="${order.orderLinePay eq 0}"><a href="javascript:;"><span class="label label-info">货到付款</span></a></c:if>
                      </c:if>
                      <%--货到付款的待发货--%>
                      <c:if test="${status ne 5}">
                          <c:if test="${order.orderLinePay eq 0}"><a href="javascript:;"><span class="label label-danger">待发货</span></a></c:if>
                      </c:if>
            ...
            <form class="form-horizontal" id="upmoneyform">
              <div class="form-group">
                ...
                <div class="col-sm-10" id="moneytipd">
                  <input type="text" class="form-control required" name="userkey" id="order_price">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-1"></div>
                <div class="col-sm-10">
                  <textarea class="form-control required" rows="5" id="up_orReason" name="reason"></textarea>
