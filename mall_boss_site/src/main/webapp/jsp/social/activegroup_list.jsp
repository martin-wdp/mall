...
<div class="page_body container-fluid">
  <div class="row">
    ...
    <input type="hidden" value="activeGroupList" id="formId"/>
    <input type="hidden" value="activegrouplist.htm" id="formName"/>
      ...
      <div class="main_cont">
        ...
        <div class="common_data p20">
          <div class="filter_area">
            <form role="form" class="form-inline" id="search_active_from" method="post">
              ...
              <div class="form-group">
                <div class="input-group">
                  <span class="input-group-addon">小组状态</span>
                  <select class="form-control" id="groupIsActive" name="groupIsActive">
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-primary" onclick="searchactive()">搜索</button>
              </div>
            </form>
          </div>
          <div class="data_ctrl_area mb20">
            ...
            <div class="data_ctrl_brns pull-left">
              <button type="button" class="btn btn-info" id="active-group">
              		<i class="glyphicon glyphicon-ok-circle"></i> 设为活跃小组
              </button>
              <button type="button" class="btn btn-info" id="common-group">
              		<i class="glyphicon glyphicon-remove-circle"></i>   取消活跃小组
              </button>
              <button type="button" class="btn btn-info" id="hot-group">
                	<i class="glyphicon glyphicon-ok-circle"></i> 设为热门小组
              </button>
              <button type="button" class="btn btn-info" id="cancel-group">
                	<i class="glyphicon glyphicon-remove-circle"></i> 取消热门小组
              </button>
              <button type="button" class="btn btn-info" id="recommend-group">
              		<i class="glyphicon glyphicon-ok-circle"></i>   设为特别推荐小组
              </button>
              <button type="button" class="btn btn-info" id="unrecommend-group">
                	<i class="glyphicon glyphicon-remove-circle"></i> 取消特别推荐小组
              </button>
            </div>
            <div class="clr"></div>
          </div>
          <form action="" method="post" id="activeGroupList">
          <table class="table table-striped table-hover">
            ...
            <tr>
              ...
              <td>
                <c:if test="${group.groupIsActive ==0}">
                  <span class="label label-default">一般</span>
                </c:if>
                <c:if test="${group.groupIsActive ==1}">
              ...
              <td>
                <c:if test="${group.groupRecommend ==0}">
                  <span class="label label-default">一般</span>
                </c:if>
                <c:if test="${group.groupRecommend ==1}">
                  <span class="label label-success">特别推荐</span>
                </c:if>
                </td>
              ...
              <td>
                <div class="btn-group">
                  <button type="button" class="btn btn-default" onclick="singleSet('commongroup.htm','activegrouplist.htm','${group.groupId}');">取消活跃</button>
                  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    <span class="caret"></span>
                    <span class="sr-only">Toggle Dropdown</span>
                  </button>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="javascript:;" onclick="singleSet('cancelhotgroup.htm','activegrouplist.htm','${group.groupId}');">取消热门</a></li>
                    <li><a href="javascript:;" onclick="singleSet('cancelrecommendgroup.htm','activegrouplist.htm','${group.groupId}');">取消特别推荐</a></li>
                  </ul>
                </div>
              </td>
            </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">添加小组分类</h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal">
          <div class="form-group">
            <label class="control-label col-sm-5">分类名称：</label>
...
<script src="<%=basePath%>js/social/activegroup.js"></script>
