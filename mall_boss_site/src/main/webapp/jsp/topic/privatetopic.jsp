...
<div class="page_body container-fluid">
  <div class="row">
    ...
    <input type="hidden" value="privatetopicList" id="formId"/>
    <input type="hidden" value="privatetopic.htm" id="formName"/>
      ...
      <div class="main_cont">
        ...
        <div class="common_data p20">
          <div class="filter_area">
            <form role="form" id="advancedForm" class="form-inline" action="privatetopic.htm" method="post">
          ...
          <div class="data_ctrl_area mb20">
            ...
            <div class="data_ctrl_brns pull-left">
              <button type="button" class="btn btn-info" onclick="showDeleteBatchConfirmAlerts('topicId','确定要删除此话题吗？');">
                <i class="glyphicon glyphicon-trash"></i> 删除
              </button>
            </div>
            <div class="clr"></div>
          </div>
          <form action="" id="privatetopicList" method="post">
            ...
            <tr>
              ...
              <td>
                ...
                <c:if test="${topic.topicTopView==1}">
                  <span class="label label-success">一般置顶</span>
                </c:if>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <input type="text" id="topic_content" value="${topic.topicContent}"/>
