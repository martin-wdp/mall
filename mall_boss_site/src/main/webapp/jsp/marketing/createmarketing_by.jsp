      ...
      <div class="row">
        ...
        <div class="col-lg-20 col-md-19 col-sm-18 main">
          <div class="main_cont">
            ...
            <h2 class="main_title">添加${pageNameChild}&nbsp;<small><a href="javascript:void(0)"  onclick="$('#by').modal('show')" style="diaplay:block; float:right; padding-right: 12px">查看帮助<i class="icon iconfont">&#xe611;</i></a></small></h2>
                ...
                <form class="form-horizontal" action="newdoaddmarketing.htm?CSRFToken=${token}"  id="addFormOne" method="post">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-3" style="width:150px;"> <label class="radio-inline">&nbsp;普通会员购物满</label></div>
                    <div class="col-sm-2">
                     	<input type="text" class="form-control required isNumber" name="shippingMoney">
                    </div>
                    <div class="col-sm-3"><label class="radio-inline">元包邮</label></div>
                    <div class="col-sm-3" style="width:150px;"> <label class="radio-inline">企业会员购物满</label></div>
                    <div class="col-sm-2">
                     	<input type="text" class="form-control required isNumber" name="vipShippingMoney">
                    </div>
                    <div class="col-sm-3"><label class="radio-inline">元包邮</label></div>
                  </div>
                  <div class="form-group">
  	...
  	/*点击添加货品的时候*/ 
		...
		var num=0;
		   ...
		   function subFormOne(obj){
		          ...
		          if(codexType=='3'){
		              var coup = $("#addFormOne").find("input[name='couponIds']");
		              if(coup.length==0){
		                  $(".cp1").html('请选择优惠券'); 
			              $(".cp1").addClass("error");
			              f=false&&f;
