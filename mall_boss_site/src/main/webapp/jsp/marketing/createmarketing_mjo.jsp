                        ...
                        <div role="tabpanel" class="tab-pane active" id="tab1">
                            <div class="common_form common_form_lg p20">
                                ...
                                <form class="form-horizontal" action="newdoaddmarketing.htm?CSRFToken=${token}"  id="addFormOne" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4">促销类型1：<input type="hidden" name="marketingType" value="0"/></label>
                                        <div class="col-sm-1"></div>
                                        <div class="col-sm-8">

                                            <c:forEach items="${codexList }" var="codex">
                                                <c:if test="${codex.codexType=='5' || codex.codexType=='8'}">
                                                    <label class="radio-inline"> <input type="radio" class="codexchoose" name="codexchoose"  <c:if test="${codex.codexType=='5'}">checked="checked"</c:if> value="${codex.codexId }-${codex.codexType }" />${codex.codexName }</label>
                                        ...
                                        <c:if test="${codex.codexType=='5' }">
                                            <div class="form-group codexDiv codexDiv${codex.codexType}">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" name="fullPrice" id="fullPrice" class="form-control required isNumber">
                                                    </div>
                                                    <div class="col-sm-1"><label class="radio-inline">元</label></div>
                                                    <div class="col-sm-1"><label class="radio-inline">减</label></div>
                                                    <div class="col-sm-1"></div>
                                                    <div class="col-sm-3">
                                                        <input type="text" name="reducePrice" id="reducePrice" class="form-control required isNumber">
                                                    </div>
                                                    <div class="col-sm-1"><label class="radio-inline">元</label></div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" name="vipFullPrice" id="vipFullPrice" class="form-control required isNumber">
                                                    </div>
                                                    <div class="col-sm-1"><label class="radio-inline">元</label></div>
                                                    <div class="col-sm-1"><label class="radio-inline">减</label></div>
                                                    <div class="col-sm-1"></div>
                                                    <div class="col-sm-3">
                                                        <input type="text" name="vipReducePrice" id="vipReducePrice" class="form-control required isNumber">
                                                    </div>
                                                    <div class="col-sm-1"><label class="radio-inline">元</label></div>
                                                </div>
                                            </div>
                                        ...
                                        <c:if test="${codex.codexType=='8' }">
                                            <div class="form-group codexDiv codexDiv${codex.codexType}" style="display:none;">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3"><label class="radio-inline">普通会员满</label></div>
                                                    <div class="col-sm-3">
                                                        <input type="text" name="fullPrice"   id="fullPrice0"class="form-control">
                                                    </div>
                                                    <div class="col-sm-1"><label class="radio-inline">元</label></div>
                                                    <div class="col-sm-1"><label class="radio-inline">打</label></div>
                                                    <div class="col-sm-1"></div>
                                                    <div class="col-sm-3">
                                                        <input type="text" name="fullbuyDiscount" class="form-control">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3"><label class="radio-inline">企业会员满</label></div>
                                                    <div class="col-sm-3">
                                                        <input type="text" name="vipFullPrice" id="vipFullPrice0"class="form-control">
                                                    </div>
                                                    <div class="col-sm-1"><label class="radio-inline">元</label></div>
                                                    <div class="col-sm-1"><label class="radio-inline">打</label></div>
                                                    <div class="col-sm-1"></div>
                                                    <div class="col-sm-3">
                                                        <input type="text" name="vipFullbuyDiscount" class="form-control">
                                                    </div>
                                                    <div class="col-sm-1"><label class="radio-inline">折</label></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1"></div>
                                        <div class="col-sm-19">
                                            <table class="table table-striped table-hover table-bordered" style="margin-bottom:0px;table-layout:fixed;">
                                                <thead style="top:0;">
                                                <tr>
                                            ...
                                            <div style="max-height:300px;overflow-y:auto;position:relative;width:952px;">

                                                <table class="table table-striped table-hover table-bordered" id="readproduct" style="table-layout:fixed;">
                                                    <tbody style="">
                                        ...
                                        <c:if test="${codex.codexType=='5' }">
                                            <div class="form-group codexDiv codexDiv${codex.codexType}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-1"></div>
                                                    <div class="col-sm-3">
                                                        <input type="text"<%-- name="reducePrice"--%> id="vipReducePrice" class="form-control required isNumber">
                                                    </div>
                                                    <div class="col-sm-1"><label class="radio-inline">元</label></div>
                                                </div>
                                            </div>
...
<div class="modal fade" id="mjo" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">添加满减促销</h4>
            </div>
            <div class="modal-body">
                <div class="modal-article">
                    <p><em>1.</em>添加满减促销，满减促销包含满减促销和满折促销，添加信息如下图</p>
                    <img src="<%=basePath %>/images/syshelp/img_c02.png" alt="">
...
<script>
    ...
    function addmore(obj,codetype){
        ...
        if(codetype==5 && length <3){
            ...
            html+= '     <input type="text" name="fullPrice" id="fullPrice'+num+'"class="form-control required isNumber">';
            html+= '</div>';
            ...
            html+= '<div class="col-sm-3">';
            html+= '    <input type="text" name="reducePrice" id="reducePrice'+num+'" class="form-control required isNumber">';
            html+='</div>';
            html+='<div class="col-sm-1"><label class="radio-inline">元</label></div>';
            ...
            html+='<div class="col-sm-3">';
            html+= '     <input type="text" name="vipFullPrice" id="vipFullPrice'+num+'"class="form-control required isNumber">';
            html+= '</div>';
            html+='<div class="col-sm-1"><label class="radio-inline">元</label></div>';
            html+= '<div class="col-sm-1"><label class="radio-inline">减</label></div>';
            html+=  '   <div class="col-sm-1"></div>';
            html+= '<div class="col-sm-3">';
            html+= '    <input type="text" name="vipReducePrice" id="vipReducePrice'+num+'" class="form-control required isNumber">';
            html+='</div>';
            html+='<div class="col-sm-1"><label class="radio-inline">元</label></div>';
        ...
        if(codetype==8 && length <3){
            ...
            html+=  '   <div class="col-sm-1"></div>';
            html+= '<div class="col-sm-3">';
            html+= '    <input type="text" name="fullbuyDiscount" id="fullbuyDiscount'+num+'" class="form-control required zeroOne">';
            html+='</div>';
            ...
            html+=  '   <div class="col-sm-1"></div>';
            html+= '<div class="col-sm-3">';
            html+= '    <input type="text" name="vipFullbuyDiscount" id="vipFullbuyDiscount'+num+'" class="form-control required zeroOne">';
            html+='</div>';
            html+='<div class="col-sm-1"><label class="radio-inline">折</label></div>';
            html+='<div class="col-sm-4" onclick="dellevel(this)"><label class="radio-inline" style="color:blue">删除本级促销</label></div></div></div>';
            $(obj).parents(".tab-pane").find(".codexDiv"+codetype).last().after(html);
