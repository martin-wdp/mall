...
<html lang="zh-cn">
      ...
      <div class="row">
        ...
        <div class="col-lg-20 col-md-19 col-sm-18 main">
          <div class="main_cont">
            ...
            <h2 class="main_title">添加${pageNameChild}&nbsp;<small><a href="javascript:void(0)"  onclick="$('#dpcx').modal('show')" style="diaplay:block; float:right; padding-right: 12px">查看帮助<i class="icon iconfont">&#xe611;</i></a></small></h2>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
	                    <c:forEach items="${codexList }" var="codex">
		                     ...
		                     <label class="radio-inline"> <%-- <input type="radio" class="codexchoose" name="codexchoose"  <c:if test="${codex.codexType=='1'}">checked="checked"</c:if> value="${codex.codexId }-${codex.codexType }" /> --%>${codex.codexName }</label>
	                    	  <%-- <c:if test="${codex.codexType=='1'}"> --%>
                  ...
                  <c:if test="${codex.codexType=='1' }">
	                   <div class="form-group codexDiv codexDiv${codex.codexType}">
		                    ...
		                    <div class="col-sm-8">
		                        <input type="text" name="offValue"
                                       ...
                                       onblur="this.v();"
                                       id="offValue" class="form-control required">
	                   ...
	                   <div class="form-group codexDiv codexDiv${codex.codexType}">
		                    ...
		                    <div class="col-sm-8">
		                        <input type="text" name="offVipValue"
                                       onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)"
                                       onblur="this.v();"
                                       id="offVipValue" class="form-control required">
                    ...
                    <%-- <c:if test="${codex.codexType=='9' }">
	                   <div class="form-group codexDiv codexDiv${codex.codexType}" style="display:none;">
		                    ...
		                    <div class="col-sm-1"></div>
		                    <div class="col-sm-8">
		                        <input type="text" name="limitCount" id="limitCount" class="form-control digits" > 
		                    </div>
	                  </div>
                  </c:if> --%>
               </c:forEach>
                  ...
                  <%--<div class="form-group">--%>
                       ...
                       <%--<div class="col-sm-19">--%>
                           <%--<label class="checkbox-inline">--%>
                               <%--<input type="checkbox" name="onCheck" onclick="allunchecked(this,'lelvelId')" checked="checked"> 全部会员--%>
                           <%--</label>--%>
                           <%--<c:forEach items="${customerLevel}" var="level">--%>
                               <%--<label class="checkbox-inline">--%>
                                   <%--<input type="checkbox"  checked="checked" value="${level.pointLelvelId }" name="lelvelId" onclick="checkLelvel(this,'lelvelId')"> ${level.pointLevelName }--%>
                               <%--</label>--%>
                           <%--</c:forEach>--%>
                       <%--</div>--%>
             ...
             <form class="form-horizontal" action="newdoaddmarketing.htm?CSRFToken=${token}"  id="addFormTwo" method="post">
                  ...
                  <c:if test="${codex.codexType=='1' }">
	                   <div class="form-group codexDiv codexDiv${codex.codexType}">
		                    ...
		                    <div class="col-sm-1"></div>
		                    <div class="col-sm-8">
		                        <input type="text" name="offValue" id="offValue" class="form-control required">
		                    </div>
	                  </div>
                  </c:if>
 ...
 <!-- Modal -->
    ...
    <div class="modal fade" id="dpcx" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">添加单品促销</h4>
          </div>
          <div class="modal-body">
            <div class="modal-article">
              <p><em>1.</em>添加单品促销，单品促销包含直降促销，添加信息如下图</p>
              <img src="<%=basePath %>/images/syshelp/img_c01.png" alt="">
    ...
    <script>
  	...
  	/*点击添加货品的时候*/ 
		...
		function doAjax(pageNo, pageSize)
		{
		    ...
		    /*AJAX查询所有的货品列表*/
		    /*$.get("queryProductForCoupon.htm?CSRFToken=${token}&pageNo="+pageNo+"&pageSize="+pageSize+"&productNo="+productName, 
		    function (data) 
		    {
		        var list = data.list;
		        var productListHtml = "";
		...
		function addpro(obj){
		    ...
		    if(obj.checked==true){
		    	...
		    	htm+='<td width="90"><img src="'+goodsImg+'" width="50" height="50"/><input type="hidden" name="goodsIdP" id="goods_Id_'+productId+'" value="'+productId+'"/></td>';
		    	htm+='<td width="110">'+goodsTag+'</td>';
		    	htm+='<td width="120">'+goodsNo+'</td>';
		    	htm+='<td  width="300">'+goodsName+'</td>';
		    	htm+='<td name="goodsPrices" width="100">'+goodsPrice+'</td>';
		          ...
		          if($("#addFormOne").valid()&&f){
                      ...
                      for(var i=0;i<goodsPrices.length;i++){
                          ...
                          if(parseInt(offValue) > parseInt(pff_price)){
                              $("#offValue_error").html("普通直降的金额不能大于促销商品的价格！");
                              $("#offValue_error").addClass("error");
                              f=false&&f;
                              return;
                          }
                          if(parseInt(offVipValue) > parseInt(pff_price)){
                              $("#offVipValue_error").html("会员直降的金额不能大于促销商品的价格！");
