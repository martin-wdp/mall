  ...
  <div class="page_body container-fluid">
      <div class="row">
          ...
          <div class="col-lg-20 col-md-19 col-sm-18 main">
            ...
            <div class="filter_area">
              <form role="form" class="form-inline" action="panicgoodslist.htm" method="post" id="searchForm">
                	<input type="hidden" name="CSRFToken" value="${token}" />
                	<input type="hidden" value="searchForm" id="formId">
                 	<input type="hidden" value="panicgoodslist.htm" id="formName">
		...
		<input type="hidden" name="codexType" value="11"/>
					...
					<td>
		                 ...
		                 <button type="button" class="btn btn-default" onclick="viewdetail(${market.marketingId });">查看</button>
		                  ...
		                  <ul class="dropdown-menu" role="menu">
                              <li><a href="javascript:void(0);" onclick="modifymarketing(${market.marketingId },11);">修改</a></li>
    ...
    <script>
     ...
     function delmarketing(marketingId){
         showDeleteOneConfirmAlert('delmarketingbyid.htm?marketingId='+marketingId+'&CSRFToken=${token}&codexType=11','确定要删除此促销吗？');
     }
