            ...
            <div class="main_cont">
                ...
                <div class="common_form common_form_lg">
                    ...
                    <form id="updateTmep" class="form-horizontal" role="form"  method="post" action="updateTempInfo.htm?CSRFToken=${token}"
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-4">页面底部区域：</label>
                            <div class="col-sm-1"></div>
                            <div class="col-sm-15">
                                <label class="radio-inline"><input type="radio" value="0"
                                                           <c:if test="${temp.pageBottomArea == 0 }">checked="true"</c:if>
                                                           name="pageBottomArea">不显示</label> <label
                                    class="radio-inline"><input type="radio" value="1"
                                                        <c:if test="${temp.pageBottomArea == 1 }">checked="true"</c:if>
                                                        name="pageBottomArea">显示</label>
                            </div>
                        </div>
