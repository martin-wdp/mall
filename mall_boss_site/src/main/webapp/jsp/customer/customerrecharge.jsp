   ...
   <jsp:include page="../page/header.jsp"></jsp:include>
    ...
    <div class="page_body container-fluid">
      <div class="row">
          ...
          <div class="main_cont">
            ...
            <div class="common_data p20">
              ...
              <div class="filter_area">
                <form role="form" class="form-inline" id="searchForm" action="initrecharge.htm" method="post">
                	 <input type="hidden" value="searchForm" id="formId">
                 	 <input type="hidden" value="initrecharge.htm" id="formName">
				 ...
				 <fmt:formatDate value="${consume.createTimeTo }" pattern="yyyy-MM-dd" var="logindateto" />
                  ...
                  <div class="form-group">
                      ...
                      <span class="input-group-addon">结束时间</span>
                        <input class="form-control" type="text" id="endTime" style="width:110px;" readonly
		...
		<input type="hidden" name="delFlag" value="2">
