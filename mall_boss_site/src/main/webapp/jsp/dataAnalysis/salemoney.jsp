            ...
            <div class="main_cont">
                ...
                <div class="common_data p20">
                    <div class="filter_area">
                        <form role="form" class="form-inline" action="saleMoney.htm" method="post" id="downform">
                    ...
                    <div class="map_area" id="main" style="height: 500px; width:950px; border: 1px solid #ccc; padding: 10px;">
                    </div>
...
//默认统计一周的时间
    ...
    $(function(){
        ...
        require.config({
            paths:{
                'echarts' : './js/build/echarts'//echarts.js的路径
            }
        });
        require(
                [
