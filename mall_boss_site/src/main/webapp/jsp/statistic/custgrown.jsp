               ...
               <jsp:include page="../page/breadcrumbs.jsp"></jsp:include>
                ...
                <div class="common_data p20">
                    <div class="filter_area">
                        <form role="form" class="form-inline" action="selectcountbytime.htm" method="post" id="downform">
                            <div class="form-group">
                                <div class="input-group date form_date" id="startpicker">
                                    <span class="input-group-addon">开始时间</span>
                                    <input class="form-control" type="text" style="width:110px;" id="startTime"
                                           value="${startTime }" name="startTime" readonly>
                            ...
                            <div class="form-group">
                                <div class="input-group date form_date" id="endpicker">
                                    ...
                                    <input class="form-control" type="text" style="width:110px;"
                                           value="${endTime }" name="endTime" id="endTime" readonly>
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <button type="button" onclick="benzhou();" class="btn btn-default">本周</button>
                            </div>
                            <div class="form-group">
                                <button type="button" onclick="shangzhou();" class="btn btn-default">上周</button>
                            </div>
                            <div class="form-group">
                                <button type="button" onclick="benyue();" class="btn btn-default">本月</button>
                            </div>
                            <div class="form-group">
                                <button type="button" onclick="shangyue();" class="btn btn-default">上月</button>
                            </div>
                            <div class="form-group">
                    ...
                    <div id="main" class="map_area" style="height:400px">  </div>
