            ...
            <div class="app-content">
                <div>
                    ...
                    <div class="cfg-content">
                        <div class="ops-bar">
                            <button class="btn btn-primary btn-sm" onclick="forThirdBrand(1,0)" type="button" data-toggle="modal" data-target="#applyBrand"><i class="glyphicon glyphicon-plus"></i>品牌申请</button>
                        </div>
                        <table class="table">
                            <thead>
                            <tr>
                            ...
                            <#if map.pb.list[0]??>
                                ...
                                <form action="updateGrandBrands.htm" class="upd_GrandBrand" method="post">
                                    <input type="hidden" value="<#if map.tab_status??>${map.tab_status}<#else>1</#if>" name="tabStatus" class="tab_status">
                                ...
                                <form class="high_search" action="<#if map.pb.url??>${map.pb.url}<#else></#if>" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<#if goodsBrand.brandLogo??>${goodsBrand.brandLogo}</#if>" alt="" width="90" height="40" /></td>
                                        ...
                                        <#if goodsBrand.reason??>
                                            <td title="${goodsBrand.reason}">
                                                <#if goodsBrand.reason?length gt 15 >
                                                     ${goodsBrand.reason?substring(0,14)}......
                                                <#else>
                                                     ${goodsBrand.reason}
                                                </#if>
                                            </td>
...
<div class="modal fade" id="delete_brand" role="dialog" aria-hidden="true" >
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" id="primary" onclick="sub_update()" type="button">确定</button>
                <button class="btn btn-primary" type="button" data-dismiss="modal">关闭</button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="applyBrand" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-item query-form">
                    <label class="control-label">品牌名称：</label>
                    <div class="controls">
                        <input type="text" class="form-control" id="brand_Name"/>
                        <button class="btn btn-primary btn-sm" onclick="forThirdBrand(1,0)" type="button">
                            查询<i class="glyphicon glyphicon-search"></i>
                        </button>
                        <span class="brand_text" style="color: red;"></span>
                    </div>
                </div>
                <form action="${basePath}/changeThirdGrandBrand.htm" method="post"  class="for_ThirdGrandBrand">
                    <div class="form-item">
                        <input type="hidden" value="<#if map.tab_status??>${map.tab_status}<#else>1</#if>" name="tabStatus" class="tab_status">
                        <input type="hidden" value="" name="brandIds" class="check_brandId">
                        <label class="control-label">品牌：</label>
                        <div class="controls iqy_div">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary"   onclick="forThirdBrand_form()" type="button">申请品牌</button>
            </div>
        </div>
    </div>
</div>
