    ...
    <div class="app show_text" style="display: none;"">
        <div class="app-container">
            <ol class="breadcrumb">
                <li>您所在的位置</li>
                <li>商品管理</li>
                <li class="active" style="color: #07d;">商家分类管理</li>
            </ol>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="closeBtn02"><span aria-hidden="true">&times;</span></button>
            ...
            <form class="addThirdCate" enctype="multipart/form-data" method="post" id="saveGoodsCateForm">
	            ...
	            <div class="modal-body">
	                <div class="form-item">
	                    ...
	                    <div class="controls">
	                        <input type="text" class="form-control catName" name="catName" id="cate_name"/>
	                ...
	                <div class="form-item">
	                    ...
	                    <div class="controls">
	                        <input type="text" class="form-control catSort" name="catSort" id="catSort"/>
	                ...
	                <div class="form-item">
	                    ...
	                    <div class="controls">
	                        <input type="text" class="form-control catSeoTitle" name="catSeoTitle" id="catSeoTitle"/>
	                ...
	                <div class="form-item">
	                    ...
	                    <div class="controls">
	                        <input type="text" class="form-control catSeoKeyword" name="catSeoKeyword" id="cateSeoKeyword"/>
	                ...
	                <div class="form-item">
	                    ...
	                    <div class="controls">
	                        <textarea class="form-control catSeoDesc" name="catSeoDesc" id="catSeoDesc"></textarea>
            ...
            <div class="modal-footer">
                <button class="btn btn-default" type="button" data-dismiss="modal" id="closeBtn01">关闭</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-item error">
                	<label class="control-label" style="width:30%;">分类下存在子分类 ,不可删除！</label>
                </div>
            </div>
            <div class="modal-footer">
