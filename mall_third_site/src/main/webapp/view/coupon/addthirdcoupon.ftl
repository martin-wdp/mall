                ...
                <div class="form-container">
                    ...
                    <form class="form-horizontal" action="addcouponthird.htm" id="addForm" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                              <label class="control-label col-xs-2">优惠券图片：</label>
                               <div class="controls col-xs-7">
                                  ...
                                  <input type="file" onclick="showImg()"  name="picFile" id="couponImg" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls col-xs-8">
                                    <input type="text" class="form-control input-xs required isNumber" name="reductionPrice"/>
                                  	  元
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="controls col-xs-4">
                                	<div class="radio radio-primary">
                                		<label><input name="couponRulesType" type="radio" value='1' />不限制（任何金额可用）</label>
                                	</div>
                                	<div class="radio radio-primary">
                                    	<label><input name="couponRulesType" type="radio" class="isNumber" value="2"/>满</label>
                                    	<input type="text" class="form-control input-xs text-center couponRulesType-input" name="fullPrice"  disabled/>元可用
                                	</div>
                                </div>
                            </div>   
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls col-xs-8">
                                    <input type="text" class="input-xs form-control text-center required digits"  name="couponCount"/>张
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-2"><b>*</b>每人限领：</label>
                                <div class="controls col-xs-8">
                                    <input type="text" class="input-xs form-control text-center required digits"  name="couponGetNo"/>张
                                </div>
                            </div>
                            <#--<div class="form-group">
