                    ...
                    <div class="cfg-content">
                        ...
                        <table class="table table-bordered orders-table">
                            ...
                            <tr class="content-row">
                                ...
                                <td>0.10</td>
                                <td>
                                    <button class="btn btn-primary btn-sm" type="button" data-toggle="modal" data-target="#outStock">出库</button>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<div class="modal fade" id="outStock" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-item">
                    ...
                    <div class="controls">
                        <img alt="" src="../images/images_06.jpg" width="60" height="60"/>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn btn-primary" type="button">打印</button>
                <button class="btn btn-primary" type="button">发货</button>
            </div>
        </div>
    </div>
</div>
