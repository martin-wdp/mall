...
<script data-require-id="echarts" src="http://echarts.baidu.com/build/echarts.js" async="">
</script><script data-require-id="echarts/chart/pie" src="http://echarts.baidu.com/build/echarts.js" async=""></script>
<style type="text/css">
    ...
    <div class="app">
        <div class="app-container">
            <ol class="breadcrumb">
                <li>您所在的位置</li>
                <li>数据分析</li>
                <li style="color: #07d;">转化率分析</li>
            </ol>

            <div class="app-content">
                <div class="chart-operation">
                    <form action="queryTakeRates.htm" method="post" id="downform">
                ...
                <h3 class="chart-caption">转化率分析</h3>
                ...
                <div class="data-chart-cont" id="chartCont">
                    <div class="mt15 mb20 ml20 mr20" id="main" style="width: 960px; height: 330px; cursor: default; background-color: rgba(0, 0, 0, 0);" _echarts_instance_="1418354017304">
                        <div style="position: relative; overflow: hidden; width: 960px; height: 330px;">
                            <div width="960" height="330" data-zr-dom-id="bg" style="position: absolute; left: 0px; top: 0px; width: 960px; height: 330px; -webkit-user-select: none;"></div>
                    ...
                    <script type="text/javascript">
                        ...
                        require(
                                [
                                    'echarts',
                                    'echarts/chart/pie' // 使饼状图就加载pie模块，按需加载
                                ],
                                function (ec) {
                                        ...
                                        series : [
                                            {
                                                ...
                                                center: ['50%', '60%'],
                                                data:[
                                                    {value:${succOrder.countSum}, name:'成功订单'},
                                                    {value:${noSuccOrder.allcount}, name:'不成功订单'},
                                                ]
                                            }
                                        ]
                                    };
