            ...
            <div class="app-content">
                <div class="form-container">
                       ...
                       <form class="form-horizontal" action="newaddmarketing.htm" id="addForm" method="post">
                         ...
                         <input type="hidden" name="marketingFlag"  value="ZK">
                            ...
                            <div class="form-group switch-wp">
                                ...
                                <div class="controls col-xs-10">
                                	<div class="radio radio-primary">
	                                    ...
	                                    <!--<label class="choose-label"><input name="goods" type="radio" data-switch="goods02"/>分类</label>
	                                    <label class="choose-label"><input name="goods" type="radio" data-switch="goods03"/>品牌</label>-->
	                                    <label class="choose-label"><input name="goods" type="radio" data-switch="goods04"/>部分参与商品</label>
	                                    <input type="hidden" id="isAlls" value="0" name="isAll" >
	                                    <span id="pc" class="spanweight"></span>
                                	</div>
                                    <div class="switch-box goods-switch">
                                        <div class="switch-item" id="goods01">

                                            <div class="form-group">
                                                <label class="control-label col-xs-2"><b>*</b>折扣：</label>
                                                <div class="controls col-xs-3">
                                                    <input type="text" class="form-control zeroOne required" name="discountInfo"  id="allgoodsdiscount"/>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <#--<div class="form-group">
                                ...
                                <div class="controls col-xs-8" style="margin-top:-7px;">
                                    <div class="radio radio-primary choose-bar">
                                        ...
                                        <input type="text" class="form-control input-xs digits giveIntegral text-center" name="giveIntegral" disabled="disabled"/>个
                                    </div>
                                    <div class="radio radio-primary choose-bar">
...
//保存商品促销
  ...
  function subForm(){
          ...
          if(!$("#allgoods").prop('checked')){
              ...
              $("#allgoodsdiscount").removeClass("required");
              $("#allgoodsdiscount").attr("name","");

              $("#allgoodsdiscount").val("");
          }else{

             $("#isAlls").val(1);
              $("#allgoodsdiscount").attr("name","discountInfo");
              $("#allgoodsdiscount").addClass("required");
