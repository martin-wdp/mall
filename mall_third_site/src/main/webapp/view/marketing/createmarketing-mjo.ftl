...
<head>
    ...
    <style>
        ...
        .mold-list li span {position:relative;}
        .mold-list li span label {position:absolute; left:0; top:25px;}
    </style>
</head>
<body>
    ...
    <div class="app show_text" style="display: none;"">
        <div class="app-container">
            <ol class="breadcrumb">
                <li>您所在的位置</li>
                <li>促销管理</li>
                <li class="active" style="color: #07d;">满减促销</li>
            </ol>
            ...
            <div class="app-content">
                <div class="form-container">
                       ...
                       <form class="form-horizontal" action="newaddmarketing.htm" id="addForm" method="post">
                         ...
                         <input type="hidden" name="marketingFlag"  value="MJO">
                                	...
                                	<div class="row">
                                		<div class="col-xs-5">
                                			<div class="input-group date form_datetime" id="startpicker">
					                            <input class="form-control required" placeholder="开始时间" type="text" id="startTime" value="" readonly
					                                   name="sTime">
                                		...
                                		<div class="col-xs-5">
                                			<div class="input-group date form_datetime" id="endpicker">
					                            <input class="form-control required" placeholder="结束时间" type="text" id="endTime" value="" readonly
					                                   name="eTime">
					                          	<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
					                       	</div>
                                		</div>
                                	...
                                	<div class="radio radio-primary">
	                                    ...
	                                    <#list codexList as codex>
	                                      <#if codex.codexType=='5' ||  codex.codexType=='8'>
		                                    <label><input name="codexchoose" type="radio"  class="codexchoose"  value="${codex.codexId }-${codex.codexType }"/>${codex.codexName }</label>
	                                      </#if>
	                                    </#list>
	                                    </#if>
                                            <input type="hidden" name="codexType" value="" />
                                            <input type="hidden" name="codexId" value="" />
                                            <span id="pctype" class="spanweight error" style="display:none;">请选择促销类型</span>
                                	</div>
                            		<div class="switch-box mold-switch">
                            		  <div class="switch-item" id="mold05">
                                            <ul class="mold-list">
                                                <li>
                                                   	 满<span><input class="form-control input-xs text-center isNumber" name="fullPrice" type="text"/></span>元，减<span><input class="form-control input-xs text-center isNumber" name="reducePrice" id="reducePrice" type="text"/></span>元
                                                </li>
                                            </ul>
                                            <button class="btn btn-primary btn-sm add-mold02" type="button"><i class="glyphicon glyphicon-plus"></i>添加多级促销</button>
                                        </div>
                                        <div class="switch-item" id="mold08">
                                            <ul class="mold-list">
                                                <li>
                                                  	  满<span><input class="form-control input-xs text-center isNumber" type="text" id="fullPricemj" name="fullPrice"/></span>元，打<span><input class="form-control input-xs text-center zeroOne" name="fullbuyDiscount" type="text"/></span>折
                            ...
                            <#--<div class="form-group">
                                ...
                                <div class="controls col-xs-8" style="margin-top:-7px;">
                                    <div class="radio radio-primary choose-bar">
                                        ...
                                        <input type="text" class="form-control input-xs text-center digits giveIntegral" name="giveIntegral" disabled="disabled"/>个
                                    </div>
                                    <div class="radio radio-primary choose-bar">
                            ...
                            <div class="form-group">
                                ...
                                <div class="control col-xs-8" id="logolabel">
                                	<div class="checkbox checkbox-primary">
...
//保存商品促销
  ...
  function subForm(){
          ...
          var codexId  =  document.getElementsByName("codexId");
          var f = true;
            if($(codexId).val()==''){
                $("#pctype").show();
                f=false&&f;
      ...
      if($(document.getElementsByName("codexId")).val()==5){
          var man=document.getElementsByName("fullPrice");
          var jian=document.getElementsByName("reducePrice");
          for(var i=0;i<jian.length;i++){
              if($(jian[i]).val()!=''&&$(man[i]).val()&&parseInt($(jian[i]).val())>=parseInt($(man[i]).val())){
                  $(jian[i]).addClass("errorinput");
                  if($(jian[i]).parent().parent().find(".errorjian").length==0){
                      $(jian[i]).parent().parent().append('<label class="errorjian" style="display: block;color:#a94442;">减值应当小于满值！</label>') ;
                  }
                  $(man[i]).addClass("errorinput");
                  f=false&&f;
              }else{
                  $(jian[i]).removeClass("errorinput");
                  $(man[i]).removeClass("errorinput");
              }
          }
      }
