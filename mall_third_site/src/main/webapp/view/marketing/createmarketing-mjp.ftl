    ...
    <div class="app show_text" style="display: none;"">
        <div class="app-container">
            <ol class="breadcrumb">
                <li>您所在的位置</li>
                <li>促销管理</li>
                <li class="active" style="color: #07d;">满件促销</li>
            </ol>
            ...
            <div class="app-content">
                <div class="form-container">
                       ...
                       <form class="form-horizontal" action="newaddmarketing.htm" id="addForm" method="post">
                         ...
                         <input type="hidden" name="marketingFlag"  value="MJP">
                            ...
                            <div class="form-group switch-wp">
                                ...
                                <div class="controls col-xs-8">
                                    ...
                                    <div class="switch-box mold-switch">
                                        <div class="switch-item" id="mold13">
                                            <ul class="mold-list">
                                                <li>
                                        ...
                                        <div class="switch-item" id="mold14">
                                            <ul class="mold-list">
                                                <li>
