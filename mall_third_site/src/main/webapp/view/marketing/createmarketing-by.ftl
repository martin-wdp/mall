    ...
    <div class="app show_text" style="display: none;"">
        <div class="app-container">
            <ol class="breadcrumb">
                <li>您所在的位置</li>
                <li>促销管理</li>
                <li class="active" style="color: #07d;">包邮促销</li>
            </ol>
            ...
            <div class="app-content">
                <div class="form-container">
                       ...
                       <form class="form-horizontal" action="newaddmarketing.htm" id="addForm" method="post">
                         ...
                         <input type="hidden" name="marketingFlag"  value="BY">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls col-xs-8">
                                   		 购物满
                                    <input type="text" class="form-control input-xs text-center required isNumber" name="shippingMoney"/>
                                    	元包邮
                                </div>
                            </div>
