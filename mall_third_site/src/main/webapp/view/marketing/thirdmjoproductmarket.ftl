            ...
            <div class="app-content">
                <div>
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="javascript:;">满减促销列表</a>
                        </li>
                    </ul>
                    <div class="cfg-content">
                        <div class="ops-bar">
                            <button class="btn btn-primary btn-sm" type="button" onclick="javascript:window.location.href='addmjomarketing.html'"><i class="glyphicon glyphicon-plus"></i>添加满减</button>
                        </div>
                       <form id="delallform" method="post" action="newdelmarketings.htm" method="post" >
                        <table class="table">
                            ...
                            <#if pb.list??>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-primary btn-sm" onclick="modifyMarketing(${market.marketingId},'MJO')">修改</button>
