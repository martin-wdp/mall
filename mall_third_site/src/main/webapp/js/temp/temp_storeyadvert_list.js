...
function fillFormData(adverId){
    /*請求地址*/
    var queryUrl=$("#basePath").val()+"/getChannelStoreyAdverById.htm";
    /*获取数据*/
    $.getJSON(queryUrl,{channelStoreyAdverId:adverId},function(data){
        /*填充表单数据*/
        if(data!=null){
...
$(function(){
    ...
    $("#createAdertBtn").click(function(){
        ...
        $("#adverPath").hide();
        $("#adverInfoForm").attr("action",$("#basePath").val()+"/createThirdTempStoreyAdver.htm");
    });
    ...
    $(".modify-btn").click(function(){
        ...
        $("#adverInfoForm").attr("action",$("#basePath").val()+"/updateThirdTempStoreyAdver.htm");
...
var num=0;
    ...
    $("div.modal-footer").on("click","button.single-delete",function(){
        $("#singleDeleteForm").attr("action",$("#basePath").val()+"/deleteThirdTempStoreyAdver.htm").submit();
    });

    /*批量删除*/
    $("div.modal-footer").on("click","button.muilty-delete",function(){
        $("#muilt-delete-form").attr("action",$("#basePath").val()+"/deleteThirdTempStoreyAdver.htm").submit();
    });
