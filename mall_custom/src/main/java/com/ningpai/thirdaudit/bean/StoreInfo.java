...
public class StoreInfo {
     ...
     * 移动端店铺街排序
     */
    private Long storeStreetort;

    /**
     * 是否显示在店铺街
     */
    private String storeStreetIsShow;
     ...
     * 店铺中商品列表
     */
    private List<GoodsProduct> goods;
    /**
     * 设置GOodsList
     * */

    public void setGoods(List<GoodsProduct> goods) {
        this.goods = goods;
    }
    /**
     * 获取GoodsList
     * */
    public List<GoodsProduct> getGoods() {
        return this.goods;
    }
    ...
    /**
     * 设置CollectionCreateTIme
     * */
    public void setCollectionCreateTime(Date collectionCreateTime) {
        this.collectionCreateTime = collectionCreateTime;
    }
    /**
     * 获取CollectionCreteTime
     * */
    public Date getCollectionCreateTime() {
        return this.collectionCreateTime;
    }

    public String getStoreStreetIsShow() {
        return storeStreetIsShow;
    }

    public void setStoreStreetIsShow(String storeStreetIsShow) {
        this.storeStreetIsShow = storeStreetIsShow;
    }

    public Long getStoreStreetort() {
        return storeStreetort;
    }

    public void setStoreStreetort(Long storeStreetort) {
        this.storeStreetort = storeStreetort;
    }
