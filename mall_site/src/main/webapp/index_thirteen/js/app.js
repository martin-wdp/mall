$(function(){
    ...
    //全部商品分类
    //$(function(){
    //    $(".dropdown-menu li").each( function(n){
    //        $(this).hover(
    //
    //            function()	{
    //
    //                if($(this).hasClass('hover')){
    //                    $(this).find("img").attr("src","../images/sort_h-0"+(n+1)+".png")
    //                }
    //                else{
    //                    $(this).find("img").attr("src","../images/sort-0"+(n+1)+".png")
    //                }
    //
    //            },
    //            function(){
    ...
    //    })
    //});
    $(".dropdown-menu li:gt(5)").hide();
    $(".showlist").mouseover(function(){
        $(".dropdown-menu li:gt(5)").show();
    }).mouseout(function(){
        $(".dropdown-menu li:gt(5)").hide();
    });
    var t = "";
    ...
    if($("#slide-brand").length > 0 && $("#slide-brand a").length > 1) {
