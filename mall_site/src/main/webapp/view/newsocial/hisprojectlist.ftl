...
<link rel="shortcut icon" href="${basePath}/favicon.ico" /><title>他的设计-摆摆网</title>
    	...
    	<div class="m_map_design mb10">
        	<div class="ta_shequ">
            	<ul>
                    ...
                    <li class="cur"><a href="${basePath}/hisprojectlist/${fanscustomerId}.html">TA的设计</a></li>
                      ...
                      <div class="house_chart">
                       ...
                       <#if pb.list??>
                    	...
                    	<div class="m_chart_item">
                            ...
                            <div class="btns2 fl">
                            <a class="common_btn_red" href="javascript:void(0)" onclick="saveproject(${pro.myProjectId})"><span>保存到我的设计</span></a>
                            </div>
                            <div class="tips">
                            	<ul>
...
function saveproject(id){
 if(showLoginDialog(2)){
		$.ajax({
			...
			data:{myProjectId:id,isProject:0},
			success:function(data){
				if(data == 1){
					$("#message").html('保存成功！！！');
					dia(2);
				}else {
					$("#message").html('已保存过此设计！！！');
					dia(2);
				}
			}
		});
