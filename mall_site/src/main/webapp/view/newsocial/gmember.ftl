            ...
            <div class="manage_cont">
            	<div class="crew_wp">
                    <ul class="manager_list mt20 clearfix">
                      <#if ((pb.list)?size>0)>
                         <#list pb.list as groupcustomer>
	                         <li class="clearfix">
	                        	<div class="rowElem clearfix fl"><input type="checkbox" value="${groupcustomer.customerId}" name="customerId"/></div>
	                            ...
	                            <div class="manager_info fl ml10">
	                            	<span>${groupcustomer.customerName}</span>
                    ...
                    <div class="manager_operating mt10 clearfix">
                    	<div class="rowElem clearfix fl mr10"><a onclick="delCustomer()"><input type="button" value="踢出小组" /></a></div>
                        <div class="rowElem clearfix fl mr10"><a onclick="blackMember()"><input type="button" value="加入黑名单" /></a></div>
                    </div><!--/manager_operating-->
                    
             <#if (pb.list?size>0)>
                <form action="groupmember.html?groupId=${groupInfo.groupId}" method="post" name="group_page_form" id="group_page_form">
...
<script type="text/javascript">
			...
			function clopage(){
			   window.location.href="groupmember.html?groupId=${groupInfo.groupId}";
			}
