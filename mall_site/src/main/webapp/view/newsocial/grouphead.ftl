...
<title>小组头像-${topmap.systembase.bsetName}</title>
...
<style type="text/css">
  ...
  .upload_bg {display:block; background:url(images/upload_bg.gif) no-repeat; width:126px; height:41px; overflow:hidden; float:left; margin-left:10px;}
</style>
</head>
<body>
 <#if (topmap.temp)??>
...
<div class="container clearfix pt20">
    <#include "common/left.ftl"> 
          <div class="rig_cont fl pr">
           <div class="clearfix rc_tit">
			<h3 class="fl fb" >小组头像</h3>
            	...
            	<div class="bg_cont mt10 tc clearfix">
            	   <div class="fl">
	                    <div class="cimg_wp mb10">  
	                    	<#if !(groupInfo.groupHead)??>
	                    		<img alt="" height="200px" id="groupHead" width="200px"  src="${basePath}/images/default_head2.jpg"/>
	                    	</#if> 
	                    	<#if (groupInfo.groupHead)??>
	                    		<img alt="" height="200px" id="groupHead" width="200px"  src="${groupInfo.groupHead }"/>
	                    	</#if>
	                    </div>
                    </div>
                    <div class="bg_wp fl ml20">
                        <div class="clearfix">
                         ...
                         <div class="clearfix mt20 mb10 ghead_box">
	                         ...
	                         <input class="pic_upload" onchange="changeGroupHead()"  name="groupPic" type="file" /></a>
                        </div>
