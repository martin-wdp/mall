...
<title>回收站-${topmap.systembase.bsetName}</title>
...
<div class="container clearfix pt20">
        ...
        <div class="rig_cont fl">
        	<h3 class="rc_tit"><a href="groupdetail/${groupInfo.groupId}.html">返回</a>回收站</h3>
            ...
            <form id="topic_form" method="post" action="">
                    ...
                    <#if pb.list??>
                     <#list pb.list as topic>
                        ...
                        <div class="ban_cont fl ml10">
                        	<a class="ban_name" href="topicdetail/${groupInfo.groupId}-${topic.topicId}.html" target="_blank">${topic.topicTitle}</a>
	                            <div class="ban_info mt10 clearfix">
	                            	<span class="fl mr20">来自：<a href="customerhomepage/${topic.customerId}.html">${topic.customerName}</a></span>
                ...
                <div class="manager_operating mt20 clearfix">
                    ...
                    <div class="rowElem clearfix fl mr10"><a onclick="restore()"><input type="button" value="还原" /></a></div>
                    <div class="rowElem clearfix fl mr10"><a onclick="del()"><input type="button" value="删除" /></a></div>
                </div><!--/manager_operating-->
                
                   <#if (pb.list?size>0)>
	                <form action="topicrecycle.html?groupId=${groupInfo.groupId}" method="post" name="group_page_form" id="group_page_form">
...
<script type="text/javascript">
			...
			function clopage(){
			   window.location.href="topicrecycle.html?groupId=${groupInfo.groupId}";
			}
