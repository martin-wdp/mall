...
<link rel="shortcut icon" href="${basePath}/favicon.ico" /><title>摆摆社区-摆摆网</title>
...
<div class="wrapper clearfix">
    	<div class="left_cont fl">
            <div class="slides_tt ">
               <#if topadvlist??>
                <#list topadvlist as adv>
                  <a href="${adv.advUrl}" target="_blank"><img src="${baseUrl}${adv.advImg}" width="880" height="300" alt="${adv.advName}"/></a>
                </#list>
               </#if>
            </div><!--cx_left-->
                 ...
                 <ul class="up-tu mt20 clearfix" style="width:900px;">
                    ...
                    <li>
                        <a href="groupdetail/${group.groupId}.html" target="_blank">
                         <#if (group.groupHead)??>
 			                 <img  width="205px" height="205px" alt="${group.groupName}" src="${baseUrl}${group.groupHead}" title="${group.groupName}"/></a>
		                <#else>
                    ...
                    <#if hotlist?size gt 0>
	                     <#list hotlist as group>
	                       <div class="jd-list">
	                         ...
	                         <#if (group.groupHead)??>
	 			                 <img  width="120px" height="120px" alt="${group.groupName}" src="${baseUrl}${group.groupHead}" title="${group.groupName}"/></a>
			                <#else>
                ...
                <ul class="jd-huo clearfix" style="width:900px;">
                   <#list activelist as active>
                     <li>
                        ...
                        <#if (active.groupHead)??>
 			                 <img  height="205px" width="205px" alt="${active.groupName}" src="${baseUrl}${active.groupHead}" title="${active.groupName}"/></a>
		                   <#else>
            ...
            <div class="jd-intro mt10">
                <div class="jd-title"><a href="${basePath}/grouplist.html" target="_blank" class="fr">查看更多小组</a>其他小组</div>
                <div class="qt-group mt10 clearfix" style="width:900px;">
                    <#if otherlist?size gt 0>
                      <#list otherlist as group>
                        <dl>
                        <dt>
                           <a href="groupdetail/${group.groupId}.html" target="_blank">
                            <#if (group.groupHead)??>
 			                 <img  height="120px" width="120px" alt="${group.groupName}" src="${baseUrl}${group.groupHead}" title="${group.groupName}"/></a>
		                   <#else>
 			                  <img  height="120px" width="120px" alt="${group.groupName}" src="${basePath}/images/default_head2.jpg" title="${group.groupName}"/></a>
		                    </#if>
                            <a class="group_name" href="groupdetail/${group.groupId}.html" target="_blank"><p> 
                             <#if (group.groupName)?length gt 6>
		                      ${(group.groupName)?substring(0,6)}
		                      <#else>${group.groupName}
		                      </#if>
		                     </p></a>
                        </dt>
                        <dd class="group-infro fl ml10" style="width:230px;">
                            <a class="group_name" href="groupdetail/${group.groupId}.html" target="_blank"> 
                             <#if (group.groupName)?length gt 10>
		                      ${(group.groupName)?substring(0,10)}
		                      <#else>${group.groupName}
		                    ...
		                    <a  href="groupdetail/${group.groupId}.html" target="_blank"> 
                            <p style="margin-top:5px; line-height:22px; color:#666;">
                             <#if (group.groupRemark)?length gt 55>
		                          ${(group.groupRemark)?substring(0,55)}...
		                         <#else>${group.groupRemark}
		                     </#if>
                            </p>
                            </a>
	                        ...
	                        <#if (topic.topicImgs)??>
	                         ...
	                         <div class="pbl-detail clearfix">
	                             ...
	                             <#if (topic.customerHead)?? &&(topic.customerHead)!="">
		                      		  <img title="${topic.customerName}" width="20" height="20" alt="${topic.customerName}" src="${baseUrl}${topic.customerHead}"/>
	                             <#else>
    		   ...
    		   <#list advlist as adv>
    	        <div id="gg_slides" class="mt20">
    	          <div class="slides_container">
	       	        <div class="slide"><a href="${adv.advUrl}" target="_blank"><img src="${baseUrl}${adv.advImg}" width="290" height="200" alt="${adv.advName}"/></a></div>
