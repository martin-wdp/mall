            ...
            <div class="menu_wp">
                ...
                <div class="menu_box cur">
                    ...
                    <ul class="menu_list">
                        ...
                        <li class="current"><a href="javascript:;">黑名单</a></li>
                    </ul><!--/menu_list-->
                </div><!--/menu_box-->
                <div class="menu_box">
            ...
            <div class="manage_cont">
            	<div class="crew_wp">
                    ...
                    <div class="manager_operating mt10 clearfix">
                    	<div class="rowElem clearfix fl mr10"><input type="button" value="解除黑名单" /></div>
