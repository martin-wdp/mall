...
<body>
    ...
    <div class="container clearfix">
            ...
            <div class="menu_wp">
            	<div class="menu_box cur">
                    ...
                    <ul class="menu_list">
                        ...
                        <li class="current"><a href="javascript:;">小组背景</a></li>
                    </ul><!--/menu_list-->
                </div><!--/menu_box-->
                <div class="menu_box">
        ...
        <div class="rig_cont fl">
        	<h3 class="rc_tit">小组背景</h3>
            <div class="manage_cont">
            	<div class="bg_cont mt10">
                    <div class="bg_picture fl"><img alt="" src="../images/images_33.jpg" /></div>
                    <div class="bg_wp fl ml20">
                        <div class="clearfix">
                        	<div class="rowElem bg_way clearfix">
                            	<input type="checkbox" />
                                <label>平铺</label>
                                <span>（选择平铺后背景图可能会被拉伸，请谨慎选择）</span>
                            </div><!--/rowElem-->
                        </div>
                        <a class="upload_bg" href="javascript:;"><input class="pic_upload" type="file" /></a>
