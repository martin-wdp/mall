            	...
            	<div class="manager_wp">
                    ...
                    <div class="search_manager mt20">
                    	<div class="rowElem clearfix">
                            ...
                            <input class="sm_btn" type="button" value="查找" />
                        </div><!--/rowElem-->
                    </div><!--/search_manager-->
                    
                    <ul class="add_list mt20 clearfix">
                    	<li class="clearfix">
                        	<div class="rowElem clearfix fl"><input type="radio" name="mg" /></div>
                    ...
                    <div class="manager_operating mt10 clearfix">
                    	<div class="rowElem clearfix fl mr10"><input type="button" value="升级为管理员" /></div>
                        <div class="rowElem clearfix fl mr10"><input type="button" value="返回" /></div>
