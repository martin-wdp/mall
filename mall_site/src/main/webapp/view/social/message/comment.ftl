        	...
        	<input type="hidden" id="customerid" value="${customeId!''}"/>
                ...
                <div class="inbox">
                    ...
                    <ul class="msg_menu">
                        ...
                        <li class="cur"><a href="javascript:;">评论</a></li>
                	...
                	<li class="clearfix">
                        ...
                        <div class="smsg_cont fl ml10">
                            <div class="clearfix lh150">
                            	<p class="fl smsg_word">您发布的话题 <a class="b_blue" href="javascript:;">燕窝美容养颜，中医药膳疗法，有菜谱分享哦~</a> 有新的评论</p>
