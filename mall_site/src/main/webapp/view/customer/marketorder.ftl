            ...
            <div class="member_right fl ml10">
                ...
                <div class="order_list switch_border">
                	<div class="tagMenu tagMenu1">
                        <ul class="rush_tabs clearfix">
                          <li <#if (!type?? || type == '0') >class="cur"</#if> data-val="0"><a href="javascript:;" >抢购订单</a></li>
		                                   ...
		                                   -->
		                                    ...
		                                    <td>
		                                        <#if order.orderStatus=="0">
		                                         ...
		                                         <#elseif order.orderStatus=="2">
		                                        	<a style="display:block;" class="order_btn1"  href="javascript:void(0)" onclick="comfirmgoods('${basePath}/customer/comfirmofmarket-marketorders-${order.orderId}.html')"  >确认收货</a>
		                                       </#if>
		                                        <!--商品id-->
...
$(document).ready(function(){
    ...
    $(".memeber_left div:eq(0) ul li:eq(2)").addClass("cur");
