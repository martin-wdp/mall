    ...
    <div class="container">
       ...
       <div class="member_box mb20">
	         	<div class="member_right ml10" style="width:1040px; margin:0 auto;">
	                ...
	                <div class="order_list switch_border mt10">
	                    <div class="content">
	                        <div class="layout">
	                            <div class="set_password member_info mb20">
	                                 <div class="success mb20">
	                                 	<div class="scs_box" style="height: 80px;line-height: 30px;">
		                                	<p class="scs_word">恭喜您，操作成功！</p>
		                                	<p class="mt20">您的密码找回成功，快去<a href="${basePath}/login.html" style="color:#dd6330;">登录</a>吧！</p>
		                                </div>
		                            </div>
	                            </div>
	                        </div>
