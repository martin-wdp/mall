    ...
    <#include "newleftmenu.ftl" />
        <div class="new_member-right">
            <div class="new_order_list">
                <div class="n-title">团购订单</div>
                <div class="tagMenu order-menu">
                    <ul class="groupon_tabs menu clearfix">
                                ...
                                <tr class="order-bd">
                                    <td class="baobei">
                                        ...
                                        <div style="height:110px;">
                                            <a class="pic" target="black" title="${order.goodsProductVo.goodsInfoId!''}" href="${basePath}/groupon/${order.goodsProductVo.goodsInfoId}"><img width="100" height="100" title="${(order.goodsProductVo.goodsInfoName)!''}" alt="${(order.goodsProductVo.goodsInfoName)!''}" src="${order.goodsProductVo.goodsInfoImgId}"/></a>
                                    ...
                                    <td>
                                        <#if order.orderStatus=="2">
                                            <a  class="buy-again"  href="javascript:void(0)" onclick="comfirmgoods('${basePath}/customer/comfirmofmarket-marketordergrounp-${order.orderId}.html')"  >确认收货</a>
                                        </#if>
                                    </td>
                                </tr>
                                </tbody>
