                                ...
                                <#if backOrderLog.backLogStatus??>
                                    <#if backOrderLog.backLogStatus == '7'>
                                        <p>
                                            ...
                                            <i></i>
                                            <span class="track-cont">退款${order.backPrice!''}元成功 (操作：平台)<#if backOrderLog.backRemark??>留言：${backOrderLog.backRemark}</#if></span>
                                        </p>
                                    </#if>
                                    <#if backOrderLog.backLogStatus == '6'>
                                        <p>
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">收货失败 (操作：平台)<#if backOrderLog.backRemark??>留言：${backOrderLog.backRemark}</#if></span>
                                        </p>
                                    </#if>
                                    <#if backOrderLog.backLogStatus == '5'>
                                        <p>
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">确认收货(操作：平台)<#if backOrderLog.backRemark??>留言：${backOrderLog.backRemark}</#if></span>
                                        </p>
                                    </#if>
                                    ...
                                    <#if backOrderLog.backLogStatus == '3'>
                                        <p>
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">申请审核不通过(操作：平台)<#if backOrderLog.backRemark??>留言：${backOrderLog.backRemark}</#if></span>
                                        </p>
                                    </#if>
                                    <#if backOrderLog.backLogStatus == '2'>
                                        <p>
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">申请审核通过(操作：平台)<#if backOrderLog.backRemark??>留言：${backOrderLog.backRemark}</#if></span>
                                        </p>
                                    </#if>
                                    <#if backOrderLog.backLogStatus == '1'>
                                        <p class="latest-track">
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">申请退款审核(操作：顾客)<#if backOrderLog.backRemark??>留言：${backOrderLog.backRemark}</#if></span>
                                        </p>
                                    </#if>
                                    ...
                                    <#if backOrderLog.backLogStatus == '9'>
                                        <p>
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">拒绝退款(操作：平台)<#if backOrderLog.backRemark??>留言：${backOrderLog.backRemark}</#if></span>
                                        </p>
                                    </#if>
                                </#if>
                            </#list>
                            ...
                            <div class="form-item">
                                ...
                                <div class="controls">
                                    <#if bOrder.backReason??>
                                        ...
                                        <#if bOrder.backReason=='3'>未按指定时间发货</#if>
                            ...
                            <tbody>
                                <#if bOrder.orderGoodslistVo?? && bOrder.orderGoodslistVo?size gt 0>
                                    ...
                                    <tr>
                                        ...
                                        <td>&yen;${list.goodsInfoSumPrice}</td>
                                    </tr>
                                    </#list>
                                </#if>
                            </tbody>
