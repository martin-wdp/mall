        ...
        <div class="member_box mb20">
            ...
            <div class="member_right fl ml10">
                <div class="memebr_title mb20">
                    <h2 class="f14 fb">取消订单</h2>
                </div>
                <div class="order_list switch_border">
                    <div class="tagMenu">
                        <ul class="menu">
                           <li><em></em><span></span>已取消的订单</li>
                        </ul>
                    </div>
                    <div class="content">
                        <div class="layout">
                            <table class="collection_goods common_table">
                                <tr>
                                    ...
                                    <th width="320">订单商品</th>
                                    <th width="120">取消时间</th>
                                    <th width="170">取消原因</th>
                                    <th width="70">操作</th>
                                </tr>
                                <#if (pb.list?size!=0)>
		                                ...
		                                <tr>
		                                    ...
		                                    <td class="goods">
			                                    ...
			                                    <#list order.goods as good>
			                                    	...
			                                    	<a title="${good.goodsName!''}" href="${basePath}/item/${good.goodsId}.html"><img width="50" height="50" title="${(good.goodsName)!''}" alt="${(good.goodsName)!''}" src="${(good.goodsImg)!''}" /></a>
			                                    </#list>
		                                    </td>
		                                    <td>
		                                    	<font color="grey">
		                                    ...
		                                    <td>
		                                        <a class="cart_btn rebuy buy-again" href="javascript:void(0)" >重新购买</a>
		                                        <input type="hidden" value="${goodsId}" />
		                                        <a href="javascript:void(0)" onclick="delorder('${basePath}/customer/delorder-${order.orderId}.html')">删除记录</a>
		                                    </td>
	                                </#list>
                                <#else>
	                                <tr>
...
$(document).ready(function(){
    ...
    $(".memeber_left div:eq(1) ul li:eq(0)").addClass("cur");
