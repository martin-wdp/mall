 ...
 <div class="section-header" style="background:url('${basePath}/index_twelve/images/cw.jpg') no-repeat top center #459d36;">
        <div class="content">
            <h1 id="logo"><a href="${topmap.systembase.bsetAddress}"><img alt="" src="${topmap.systembase.bsetLogo}" style="height:40px;width:165px;"/></a>
                <div class="logoBanner"><a href="${basePath}/${(topmap.logoAdv.adverHref)!'#'}"><img src="${(topmap.logoAdv.adverPath)!'${basePath}/index_twelve/images/ad.jpg'}" style="height:40px;width:165px;"/></a></div>
            </h1>
...
<script id="sort" type="text/html">
    <ul class="list dropdown-menu">
        ...
        <li>
            <img alt="" src="{{value.simg}}" style="width:25px;height:24px;"/>
