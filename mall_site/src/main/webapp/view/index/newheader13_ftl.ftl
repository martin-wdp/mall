...
<div class="section-header">
        <div class="content">
            <h1 id="logo"><a href="${topmap.systembase.bsetAddress}"><img alt="" src="${topmap.systembase.bsetLogo}" style="width:165px;height:40px;"/></a>
                <div class="logoBanner"><a href="${basePath}/${(topmap.logoAdv.adverHref)!'#'}"><img src="${(topmap.logoAdv.adverPath)!'${basePath}/index_thirteen/images/ad.jpg'}" style="width:115px;height:36px;"/></a></div>
            </h1>
