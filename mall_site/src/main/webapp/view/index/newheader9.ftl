        ...
        $.ajax({ url: "${basePath}/minisscart.htm",  async:false ,success: function(datee){
            ...
            if(cartgoods != null && cartgoods.length>0){
                ...
                for(var i = 0 ; i < cartgoods.length ; i++) {
                    ...
                    var productNames = cartgoods[i].productName;
                    ...
                    if (cartgoods[i].fitId == null) {
                        ...
                        '   <i></i><img src="' + cartgoods[i].productPic + '" alt="" width="60" height="60">' +
                        '  </div>' +
                        ' </a>' +
                        '</div>' +
                        '<div class="mcSqe">' +
                        '<p><a  href="${basePath}/item/' + cartgoods[i].goodsInfoId + '">' + productNames + '</a></p>' +
                        '</div>' +
                        ...
                        for (var j = 0; j < goodsList.length; j++) {
                            ...
                            '<div class="table-cell">' +
                            '   <i></i><img src="' + goodsList[j].productPic + '" alt="" width="60" height="60">' +
                            '  </div>' +
                            ' </a>' +
                            '</div>' +
                            '<div class="mcSqe">' +
