    ...
    <link rel="stylesheet" href="${basePath}/index_two/css/header.css"/>
	...
	<div class="top">
    	<div class="top_wp clearfix">
            ...
            <ul class="top_nav fr clearfix">
                ...
                <li><a href="${basePath}/customer/insideletter.html" class="fl mes_tips" target="_blank">
            ...
            <!--	<#if cust??>
                ...
                <li class="my_store pr">
                   ...
                   <li><span class="t_line">|</span><a href="${basePath}/helpfirstpage.html">帮助中心</a></li>
            </ul><!--/top_nav-->
            <#if cust??>
