...
<div id="sectionHeader" class="section-header">
            <div class="content">
                ...
                <div class="cartfd">
                    ...
                    <div class="cartit">
                        <span><i class="iconfont">&#xe601;</i><a href="${basePath}/myshoppingcart.html">购物车</a></span>
                ...
                <div class="search searchdiv">
                    <form action="${basePath}/goods/searchproduct2.html" class="mallSearch-form" method="get">
                        <label for=""></label>
                        <input type="text" class="inputSearch" name="title" placeholder="搜索您需要的商品" value="${(keyWorlds)!''}" />
