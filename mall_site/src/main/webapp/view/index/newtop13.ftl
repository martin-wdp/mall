...
<link type="text/css" rel="stylesheet" href="${basePath}/index_thirteen/css/header.css" />
<!--<script src="${basePath}/index_thirteen/js/jquery-1.11.1.min.js"></script>-->
<script src="${basePath}/js/jquery-1.7.2.min.js"></script>
<script src="${basePath}/index_thirteen/js/jquery.slides.min.js"></script>
<script src="${basePath}/index_thirteen/js/jcarousellite_1.0.1.js"></script>
<script src="${basePath}/index_thirteen/js/angular.min.js"></script>
<script src="${basePath}/index_thirteen/js/template.js"></script>
<script src="${basePath}/index_thirteen/js/jquery.lazyload.min.js"></script>
<script src="${basePath}/js/jsOperation.js"></script>
<script src="${basePath}/index_thirteen/js/app.js"></script>
