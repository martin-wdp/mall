        ...
        <div class="Bargain">
        	<#if pageAdvs?? && (pageAdvs?size>0)>
        		<#list pageAdvs as pageAdv>
            		...
            		<div class="item-img"><a href="${pageAdv.adverHref}"><img class="lazy" data-original="${pageAdv.adverPath}" width="290" height="198"/></a></div>
            		</#if>
            	</#list>
            </#if>
        ...
        <div class="proLists" id="proLists0${floors.floorId}">
            ...
            <div class="pro-con">
                <div class="pro-left">
                    ...
                    <#if adv.adverSort==1>
                        <a href="${adv.adverHref}"><img class="lazy" data-original="${adv.adverPath}" width="891" height="282"/></a>
                    </#if>
                    </#list>
                    </#if>
                    </div>
                    <div class="proItem left">
                        <div class="clearfix">
                            ...
                            <div class="proItem-s left">
                                <a href="${adv.adverHref}"><img class="lazy" data-original="${adv.adverPath}" width="286" height="282"/></a>
                            </div>
                            </#if>
                            </#list>
                            </#if>
                        ...
                        <div class="proItem-l">
                    		...
                    		<#list floors.indexAdvertList as adv>
                    		<#if (adv.adverSort==4)>
                            <a href="${adv.adverHref}"><img class="lazy" data-original="${adv.adverPath}" width="588" height="282"/></a>
                            </#if>
                            </#list>
                            </#if>
                    ...
                    <div class="proItem-r left">
                    	...
                    	<#list floors.indexAdvertList as adv>
                    	<#if (adv.adverSort==5)>
                        <a href="${adv.adverHref}"><img class="lazy" data-original="${adv.adverPath}" width="287" height="582"/></a>
                        </#if>
                        </#list>
                        </#if>
                    </div><!--proItem-r-->
                    ...
                    <div class="slide">
                        ...
                        <#list trademarkList as trademark >
                		  <#if (trademark.sort>=1) && (trademark.sort<=16)>
                            <li>
                                <a href="#">
                                    <img class="lazy" data-original="${trademark.logoSrc}" width="130" height="88"/>
...
$(function() {
			...
			$("img.lazy").lazyload({
				...
				effect: "fadeIn",
				failurelimit : 10,
				placeholder: "${basePath}/index_thirteen/images/lazy_img.png",
