    ...
    <div class="page_right fr  operation_bar">
        <div class="operation_wp clearfix">
            ...
            <div class="op_pages fr">
                <span class="mr10"><b>${data.pb.pageNo}</b>/<#if data.pb.totalPages==0>1<#else>${data.pb.totalPages}</#if></span>
			<#if (data.pb.pageNo==1)>
                <a class="op_prev no_pages" href="javascript:;">上一页</a>
			<#else>
                <a class="op_prev" pages="${data.pb.prePageNo}"  href="javascript:;" onclick="prevpage(${data.pb.prePageNo});">上一页</a>
			</#if>
			<#if (data.pb.lastPageNo > data.pb.pageNo)>
                <a class="op_next  changePages" pages="${data.pb.nextPageNo}" href="javascript:void(0);" onclick="nextpage(${data.pb.nextPageNo})">下一页</a>
			<#else>
        ...
        <div class="goods_wp mt20">
			...
			<#if (data.pb.data)?? && (data.pb.data?size>0)>
				<#list data.pb.data as product>
                    <li class="goodsBox">
                        <div class="gd_wp">
                            <div class="g-img">
                                <a target="_blank" href="${basePath}/item/${product.goodsInfoId}.html" alt="${product.goodsInfoName!''}" title="${product.goodsInfoName!''}"><img class="lazy" alt="${product.goodsInfoName!''}" title="${product.goodsInfoName!''}" data-original="<#if  product.imgList?? && product.imgList?size &gt; 0 >${product.imgList[0].imageBigName!''}</#if>" width="226" height="226" src="" style="display: inline;"></a>
                            </div><!--/g-img-->
                            ...
                            <p class="g-name mt5"><a target="_blank" href="${basePath}/item/${product.goodsInfoId}.html" alt="${product.goodsInfoName!''}" title="A${product.goodsInfoName!''}">${product.goodsInfoName!''}</a></p>
                            ...
                            <div class="good-operation tc mt15">
                                ...
                                <a class="cllect_btn_list" product_id="${product.goodsInfoId}" href="javascript:;">收藏</a>
			...
			<#else>
                ...
                <#if data.pb.endNo==0>
                    <a class="cur" href="javascript:;">${pageNo}</a>
                    <#else>
