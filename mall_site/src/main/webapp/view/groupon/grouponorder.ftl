...
<@htmlBody>
	...
	<div class = "logo fl head2">
       ...
       <form  id="subForm" action="${basePath}/order/submitgrouponorder.html" method="post">
                	...
                	<div class="invoice_show fill_item_show">
                        ...
                        <table>
                            <tr>
                                ...
                                <input type="hidden" name="ch_voinceType" class="ch_invoceTypeValue" value="1" />
                            </tr>
                            <tr>
         		...
         		<div class="order_fill_item">
                	<div class="goods_show fill_item_show">
                        ...
                        <table class="goods_list mb10">
                            ...
                            <tr>
                                <td>${groupons.goodsProductVo.goodsInfoItemNo}</td>
                                <td><a href="${basePath}/groupon/${groupons.goodsProductVo.goodsInfoId}">${groupons.goodsProductVo.productName}</a></td>
                                <td style="color:#e64f25;">￥${(groupons.goodsProductVo.goodsInfoPreferPrice*groupons.marketing.groupon.grouponDiscount)?string("0.00")}</td>
                                <input type="hidden" id="goodsPrice" value="${groupons.goodsProductVo.goodsInfoPreferPrice*groupons.marketing.groupon.grouponDiscount}">
                                <input type="hidden" id="goodsStock" value="${groupons.goodsProductVo.goodsInfoStock}">
                                <td>
                                	<div class="cell g_count">
					                    <div class="count">
											<input type="hidden" value="${groupons.goodsProductVo.goodsInfoId}" name="productId">
                                ...
                                <td style="color:#e64f25;">￥<span class="goods_priceh">￥${(groupons.goodsProductVo.goodsInfoPreferPrice*groupons.marketing.groupon.grouponDiscount)?string("0.00")}</span></td>
