        	...
        	<div class="product_info fl ml20">
                ...
                <div class="pss_two_cona" style="float:none;">
	                <div class="pss_jp_price" style=" margin-top:15px;">
	                    <div class="pss_big_sale"><span class="f24">¥</span>${(map.detailBean.productVo.goodsInfoPreferPrice*market.groupon.grouponDiscount)?string("0.00")}</div>
	                    <div class="pss_dazhe">
	                        <div class="pss_court_d">${market.groupon.grouponDiscount}折</div>
                ...
                <div class="pss_pp">
                	...
                	<a href="javascript:;" class="pss_hot_buy buy_goods">立即参团</a>
                </div>
        	</div>
        </div>
	</div>
		...
		<div class="product_detail">
                    <div class="tit_wp">
                        <div class="det_title detail_nav clearfix">
                            ...
                            <a class="add-cart-btn fr buy_goods" href="javascript:;">马上团！</a>
                        </div><!--/det_title-->
                    </div><!--/tit_wp-->
...
注：本站商品信息均来自于厂商，其真实性、准确性和合法性由信息拥有者（厂商）负责。本站不提供任何保证，并不承担任何法律责任。</p>
	...
	<!-- 保存商品参数部分相关参数 -->
     <form id="paramGoodsForm" action="${map.detailBean.productVo.goodsInfoId}" method="post">
      ...
      <form id="paramGrouponForm" method="post" action="${basePath}/order/subgrouponorder.html">
    ...
    <div class="container">
        <!--这是底部-->
        <div class="pt30"><img src="../images/foot.jpg"/></div>
    </div>
