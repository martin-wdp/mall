...
<#assign basePath=request.contextPath>
    ...
    <link rel="stylesheet" type="text/css"
          href="http://cdn.bootcss.com/bootstrap-datepicker/1.4.0/css/bootstrap-datepicker.min.css">
    <link href="${basePath}/css/qpmaterial.css" rel="stylesheet">
    <link href="${basePath}/css/qpripples.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="${basePath}/css/qpstyle.css"/>
    <link rel="stylesheet" type="text/css" href="${basePath}/css/qpthird.css"/>
</head>
<body>
<div class="container">
    <div class="store">
        <div class="wrapper-app">
            ...
            <div id="content" style="text-align: left;" style="width: 800px">
                <div class="create-wrapper" >
                    ...
                    <div class="agreement-cont">
                        ...
                        <label class="agree-opt"><input type="checkbox" id="read_pro"/>我已阅读并同意以上协议</label><span
                            id="tip_span" class="hide">请先阅读入驻协议!</span>

                        <div class="create-opt">
                            <button class="btn btn-large btn-primary" type="button"
                                    onclick="javascript:window.location.href='index.html'">上一步
                            </button>
                            <button class="btn btn-large btn-primary" type="button" onclick="confirmOpen();">下一步
                            </button>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="${basePath}/js/openstore.js"></script>
<script>
    $(function () {
        $.material.init();
    });
