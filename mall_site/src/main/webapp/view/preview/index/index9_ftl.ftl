                ...
                <#if avc?? && (avc?size>0)>
	        		<#list avc as bigAdvert>
		        		<#if (bigAdvert.adverSort>=1 && bigAdvert.adverSort<=5)>
		                    <a href="${bigAdvert.adverHref}" class="slide"><img class="lazy" data-original="${bigAdvert.adverPath}" alt=""/></a>
		                </#if>
	                 </#list>
            	</#if>                      
                </div>
                ...
                <div class="best-selling">
                    <div class="selling-wp">
                        ...
                        <#if hotSale?? && (hotSale?size>0)>
                            ...
                            <li>
                                <div class="sell-box">
                                    <a href="item/${(hotgoods.goodsproductId?c)!''}" class="pro-img"><img class="lazy" alt="" data-original="${(hotgoods.goodsproductImgsrc)!''}"/></a>
                                    
                                    <p class="pro-name"><a href="item/${(hotgoods.goodsproductId?c)!''}">
...
<#if (floor.floorList)?? && (floor.floorList?size > 0)>
 ...
 <#if (floors.floorId%2==0) >  
            ...
            <div class="brands-bar">
                <div class="brands-box">
	                ...
	                <#list trademarkList as trademark >	    
	                  <li><a href="${trademark.logoSrc}"><img class="lazy" alt="" data-original="${trademark.logoSrc}"/></a></li>
                    </#list>
                    </#if>                        
                    </ul>
                </div>
        ...
        <#if (floor.floorList)?? && (floor.floorList?size > 0)>
        	<#list floor.floorList as floors> 
	        <a href="#proLists0${floors.floorId}" class="sideItem"><img alt="" data-original="${floors.storeyRightImg}"/>${floors.storeyName}</a>
	        </#list>
	    </#if>
	    <#if customerService.onlineIndex=='Y'>
	        <a href="javascript:;" class="customer_service"><i class="iconfont">&#xe603;</i>联系客服</a>
	    </#if>
