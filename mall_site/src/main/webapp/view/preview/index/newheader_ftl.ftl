    					...
    					<dt>
    						...
    						<#list cBar.barCate as bcate>
	    						...
	    						<#if bcate.cateId==-1>
	    							...
	    							<#else>
	    								<a href="${basePath}/item/${bcate.temp2!'0'}">${bcate.cateName}</a>
	    							</#if>
	    						<#elseif bcate.cateId??>
                            	...
                            	<dl>
                                    <dt>
                                    	...
                                    	<#if cbtwo.goodsCatId==-1>
			    							...
			    							<#else>
			    								<a href="${basePath}/item/${cbtwo.url!'0'}">${cbtwo.name}</a>
			    							</#if>
                                    	<#else>
    		...
    		<ul class="sort_list clearfix">
    			...
    			<#list topmap.navList as nav>
    				...
    				<#else>
    					...
    					<#else>
			    			<li><a href="${basePath}/barchannelview/${(nav.barId?c)!''}">${(nav.barName)!''}</a></li>
    					</#if>
    				</#if>
    			</#list>
    			</#if>
