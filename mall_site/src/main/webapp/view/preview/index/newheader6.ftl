...
<!--<script src="${basePath}/index_six/js/jquery-1.11.1.min.js"></script>-->
...
<script src="${basePath}/index_six/js/jquery.slides.min.js"></script>
<script src="${basePath}/index_six/js/jcarousellite_1.0.1.js"></script>
<script src="${basePath}/index_six/js/angular.min.js"></script>
<script src="${basePath}/js/jsOperation.js"></script>
<script src="${basePath}/index_six/js/app.js"></script>
<#include "newheader6_ftl.ftl"/>
