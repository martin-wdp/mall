...
<div class="section-header">
    <div class="content">
        <h1 id="logo">
            ...
            <div class="logoBanner"><a href="${topmap.logoAdv.adverHref}"><img alt="" src="${topmap.logoAdv.adverPath}"></a></div>
            </#if>
        </h1>
            ...
            <div class="miniCart hide">
                ...
                <div class="mCartHandler clearfix">
                            <span class="mcCashier">
                                ...
                                <span class="mcGo">结算</span><!-- no-mcGo置灰状态 -->
                            </span>
        ...
        <div class="search searchdiv">
            <form class="mallSearch-form" action="${basePath}/goods/searchproduct2.html" method="post">
                <div class="mallSearch-input">
                    ...
                    <button class="btnSearch" type="submit" onclick="checkSearch()"></button>
                </div>
            </form>
           ...
           <#list topmap.classifyBar.classifyBarList as cBar>              
            ...
            "links":[
                  ...
                  <#list cBar.barCate as bcate>
                		...
                		<#elseif bcate.cateId??>
                			{"lname":"${bcate.cateName}","lhref":"${basePath}/list/${bcate.temp1!'0'}-${bcate.cateId?c}.html"},
                		</#if>
                  </#list>
                  </#if>
