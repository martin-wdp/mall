...
<div class="section-header">
        <div class="content">
            <h1 id="logo"><a href="javascript:;"><img alt="" src="${topmap.systembase.bsetLogo}"/></a>
                <div class="logoBanner"><a href="${basePath}/${(topmap.logoAdv.adverHref)!'#'}"><img src="${(topmap.logoAdv.adverPath)!'${basePath}/index_thirteen/images/ad.jpg'}"/></a></div>
            </h1>
            ...
            <div class="search searchdiv">
                <form class="mallSearch-form" action="${basePath}/goods/searchproduct2.html" method="post">
                    <div class="mallSearch-input">
                        ...
                        <input class="inputSearch" name="title" type="text" autocomplete="off" value="${(map.searchBean.title)!''}"/>
                        <#else>
                ...
                <#list topmap.hotsearch as hots>
                	<#if (hots_index>=0) && (hots_index<9)>
	                	<#if (hots.keyword?length>4)>
	                    <a href="javascript:;" title="${hots.keyword}" onclick='changeSearchKey(this);'>${hots.keyword?substring(0,4)}</a>
	                    <#else>
