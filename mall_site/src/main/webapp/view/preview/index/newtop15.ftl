...
<!--<script src="${basePath}/index_fifteen/js/jquery-1.11.1.min.js"></script>-->
<script src="${basePath}/js/jquery-1.7.2.min.js"></script>
<script src="${basePath}/index_fifteen/js/jquery.slides.min.js"></script>
<script src="${basePath}/index_fifteen/js/jcarousellite_1.0.1.js"></script>
<script src="${basePath}/index_fifteen/js/angular.min.js"></script>
<script src="${basePath}/index_fifteen/js/template.js"></script>
<script src="${basePath}/js/jsOperation.js"></script>
<script src="${basePath}/index_fifteen/js/jquery.lazyload.min.js"></script>
<script src="${basePath}/index_fifteen/js/app.js"></script>
