...
<title>修改话题-${topmap.systembase.bsetName}</title>
  ...
  <form id="topicForm" method="post" action="">
	...
	<div class="left_cont fl">
            ...
            <div class="pub_title mt30 clearfix" >
            	<em class="fl">标题：</em>
                <div class="rowElem clearfix fl"><input class="pub_text" type="text" maxlength="30" onKeyUp="length30()" name="topicTitle" id="topicTitle" value="${(topic.topicTitle)!''}"  placeHolder="写下你所知道的一句话技巧（要求置顶）" /></div>
             ...
             <#--<div class="pub_title_a clearfix mt10">
            	...
            	<div class="rowElem clearfix fl"><select name="topicCateId" style="color:#666666;" >
            	  	<option value="0" <#if topic.topicCateId=='0'> selected="selected"</#if>>客厅</option>
					<option value="1" <#if topic.topicCateId=='1'> selected="selected"</#if>>卧室 </option>
            	  	<option value="2" <#if topic.topicCateId=='2'> selected="selected"</#if>>书房</option>
					<option value="3" <#if topic.topicCateId=='3'> selected="selected"</#if>>厨房</option>
            	  	<option value="4" <#if topic.topicCateId=='4'> selected="selected"</#if>>餐厅</option>
					<option value="5" <#if topic.topicCateId=='5'> selected="selected"</#if>>阳台花园</option>
            	  	<option value="6" <#if topic.topicCateId=='6'> selected="selected"</#if>>卫浴间</option>
					<option value="7" <#if topic.topicCateId=='7'> selected="selected"</#if>>飘窗</option>
            	  	<option value="8" <#if topic.topicCateId=='8'> selected="selected"</#if>>套房</option>
					<option value="9" <#if topic.topicCateId=='9'> selected="selected"</#if>>其他</option>
            	</select></div>
            </div><!--/pub_title-->
            <div class="pub_wp mt20">
            	<div style="width:750px;margin:0;"><textarea class="ff_textarea" id="topicContent" name="topicContent" style="width:auto;">${(topic.topicContent)!''}</textarea></div>
                <div class="dont_hh">话题内容请勿超过10000字(注:上传图片大小不超过1M)</div>
            </div><!--/pub_wp-->
            <div class="rowElem pub_btns clearfix mt15">
            	<a id ="but" onclick="savetopic()"><input type="button" value="确认修改" /></a>
        ...
        <div class="right_cont fr">
        	<div class="topic_group clearfix">
            	...
            	<#if (group.groupHead)??>
	            	<img alt="${group.groupName}" src="${group.groupHead}" width="50px" height="50px"/>
            	<#else>
    	        	<img alt="${group.groupName}" src="${basePath}/images/default_head3.jpg" width="50px" height="50px"/>
            	</#if>
            	</a>
                <div class="fl ml10 tb_info">
                	<a class="tg_name" href="${basePath}/groupdetail/${group.groupId}.html"> 
