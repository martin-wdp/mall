...
<body>
 <#if (topmap.temp)??>
	...
	<input  type="hidden" id="groupName" value="${groupName!''}"/>
    	<div class="left_cont fl">
        	<div class="groupBox">
                ...
                <form id="group_search_form" action="groupsearchlist.html" method="get">
                <div class="group_search mt10">
                	<em>话题搜索：</em>
                    <input class="g_search_text" type="text" name="groupName" value="${groupName!''}"/>
            ...
            <div class="search_wp mt20">
               <#if gtopicName??>
            	<h3 class="search_tit"><em>“${topicName}”</em>的搜索结果</h3>
                    ...
                    <#if pb.list??>
                     <#list pb.list as group>
	                      <li class="clearfix">
	                    	...
	                    	<#if (group.groupHead)??>
	                    	<img alt="${group.groupName}" height="120px" width="120px" src="${baseUrl}${group.groupHead}" />
	                    	<#else>
    ...
    <div class="mask"></div>
     <div class="dialog dia1" style="width:300px; height:120px;">
