...
public class UpyunConf implements java.io.Serializable {
     ...
     * 取得：记录ID
     * 
     * @return int 记录ID {@link UpyunConf#upyunId}
     */
     ...
     * 取得：设置方案标题
     * 
     * @return String 设置方案标题 {@link UpyunConf#title}
     */
     ...
     * 取得：设置方案代码
     * 
     * @return String 设置方案代码 {@link UpyunConf#setCode}
     */
     ...
     * 取得：空间名
     * 
     * @return String 空间名 {@link UpyunConf#bucketName}
     */
     ...
     * 取得：用户名
     * 
     * @return String 用户名 {@link UpyunConf#userName}
     */
     ...
     * 取得：密码
     * 
     * @return String 密码 {@link UpyunConf#passWord}
     */
     ...
     * 取得：空间地址
     * 
     * @return String 空间地址 {@link UpyunConf#urlPath}
     */
     ...
     * 取得：链接时间
     * 
     * @return int 链接时间 {@link UpyunConf#connectTime}
     */
     ...
     * 取得：debug模式
     * 
     * @return String debug模式 {@link UpyunConf#debug}
     */
     ...
     * 取得：缩略图
     * 
     * @return String 缩略图 {@link UpyunConf#gmkerl}
     */
     ...
     * 取得：旋转
     * 
     * @return String 旋转 {@link UpyunConf#rotate}
     */
     ...
     * 取得：裁剪
     * 
     * @return String 裁剪 {@link UpyunConf#crop}
     */
     ...
     * 取得：操作类型
     * 
     * @return int 操作类型 {@link UpyunConf#optionType}
     */
     ...
     * 取得：ContentMD5
     * 
     * @return String ContentMD5 {@link UpyunConf#contentMd5}
     */
     ...
     * 取得：访问密钥
     * 
     * @return String 访问密钥 {@link UpyunConf#visitSecretKey}
     */
     ...
     * 取得：缩略图类型
     * 
     * @return String 缩略图类型 {@link UpyunConf#thumbnailType}
     */
     ...
     * 取得：缩略图参数值
     * 
     * @return String 缩略图参数值 {@link UpyunConf#thumbnailNumber}
     */
     ...
     * 取得：缩略图质量
     * 
     * @return int 缩略图质量 {@link UpyunConf#thumbnailQuality}
     */
     ...
     * 取得：缩略图锐化
     * 
     * @return String 缩略图锐化 {@link UpyunConf#thumbnailSharpen}
     */
     ...
     * 取得：缩略图版本名称
     * 
     * @return String 缩略图版本名称 {@link UpyunConf#thumbnailVersion}
     */
     ...
     * 取得：图片旋转
     * 
     * @return String 图片旋转 {@link UpyunConf#imageRotation}
     */
     ...
     * 取得：图片裁剪
     * 
     * @return String 图片裁剪 {@link UpyunConf#imageTailor}
     */
     ...
     * 取得：启用
     * 
     * @return String 启用 {@link UpyunConf#usedStatus}
     */
     ...
     * 取得：扩展字段1
     * 
     * @return String 扩展字段1 {@link UpyunConf#expFleid1}
     */
     ...
     * 取得：扩展字段2
     * 
     * @return String 扩展字段2 {@link UpyunConf#expFleid2}
     */
     ...
     * 取得：添加人
     * 
     * @return int 添加人 {@link UpyunConf#insertId}
     */
     ...
     * 取得：添加时间
     * 
     * @return Date 添加时间 {@link UpyunConf#insertDate}
     */
     ...
     * 取得：修改人
     * 
     * @return int 修改人 {@link UpyunConf#modifyId}
     */
     ...
     * 取得：修改时间
     * 
     * @return Date 修改时间 {@link UpyunConf#modifyDate}
     */
     ...
     * 取得：删除标识
     * 
     * @return int 删除标识 {@link UpyunConf#deleteStatus}
     */
