 ...
 * @version V1.0
 */
public interface IUpyunConfBiz {
     ...
     * @param pageBean
     *            分页对象
     * @return 又拍云设置对象的集合 @ 自定义异常对象
     * @author NINGPAI_xiaomm
     * @since 2014-03-24 15:44:09
     */
    PageBean getUpyunConfByField(Map<String, Object> parameter, PageBean pageBean);
     ...
     * @since 2014-03-24 15:44:09
     */
    PageBean queryUpyunConfByPage(Map<String, Object> parameter, PageBean pageBean);
