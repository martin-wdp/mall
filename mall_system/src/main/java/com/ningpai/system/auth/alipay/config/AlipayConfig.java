package com.ningpai.system.auth.alipay.config;
...
public final class AlipayConfig {
    ...
    /**
     * 域名不能写成http://localhost/create_direct_pay_by_user_jsp_gb/return_url.jsp
     * ，否则会导致return_url执行无效
     */
    ...
    public static final String INPUT_CHARSET = ConstantUtil.UTF;
