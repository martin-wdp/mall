...
public class ShoppingCartMapperImpl extends BasicSqlSupport implements
    ...
    public int updateShoppingCartNum(ShoppingCart shoppingCart) {
        return this.update(
                "com.ningpai.web.dao.ShoppingCartMapper.updateShoppingCartNum",
                shoppingCart);
    }
    /**
     * 查询我已经加入购物车的数量
     ...
     */
    @Override
    public Integer shoppingCartGoodsSum(Long customerId) {
        return this.selectOne(
                "com.ningpai.web.dao.ShoppingCartMapper.shoppingCartGoodsSum",customerId);
    }
