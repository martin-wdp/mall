    ...
    public Order queryGoodsProducts(Long orderId) {
        ...
        if (orderGoodsList != null && !orderGoodsList.isEmpty()) {
            for (int i = 0; i < orderGoodsList.size(); i++) {
                ...
                Long marketingActivityId = orderGoods.getGoodsActiveMarketingId();
                Long marketingId = orderGoods.getGoodsMarketingId();
                Long goodsGroupId = orderGoods.getGoodsGroupMarketingId();
                if(marketingActivityId != null && marketingActivityId != 0){//抢购、满减、满折、直降
                    orderGoods.setMarketing(marketingService.marketingDetail(marketingActivityId));
                }
                if(marketingId != null && marketingId != 0){//抢购
                    orderGoods.setMarketing(marketingService.marketingDetail(marketingId));
                }
                if(goodsGroupId != null && goodsGroupId != 0){//团购
                    orderGoods.setMarketing(marketingService.marketingDetail(goodsGroupId));
                }
