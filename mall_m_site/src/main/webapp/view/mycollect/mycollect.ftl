    ...
    <#else>
        ...
        <div class="cart_check container-fluid">
            <div class="row">
                ...
                <div class="col-xs-6">
                    <a href="javascript:;" onclick="onpay()" class="go_check">加入购物车</a>
                </div>
            </div>
        </div><!-- /cart_check -->
</div><!-- /cart_list -->
<div class="wrap">
    ...
    <div class="go_buy">
        <button type="button" class="btn btn-warning btn-lg " style="width:45%;float:left;background:#F6AB02;border:none;" onclick="goShop()">去逛逛</button>
        <button type="button" class="btn btn-warning btn-lg " style="width:45%;float:right;background:#BBB9BA;border:none;" onclick="goShop()">查看收藏</button>
    </div>
</div>
</form>

<div class="enjoy">
    <p style="border-top:1px solid #D0D0D0;border-bottom:1px solid #D0D0D0;background:#F2F2F2;height:60px;line-height:60px;font-size:18px;text-align:center;">您可能感兴趣的商品</p>
    <!--商品列表-->
