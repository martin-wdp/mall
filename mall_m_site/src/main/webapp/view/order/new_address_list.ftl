...
<html lang="zh-cn">
 ...
 <script>if(myObj&&myObj.setHomeFlag){myObj.setHomeFlag('false');}</script></head>
        ...
        <div class="wrap">
            <div class="addressBox">
                <div class="add-address">
                    <a href="${basePath}/toAddAddress.htm?needRetrun=${needRetrun!'0'}"><button class="mui-btn mui-btn-danger mui-btn-flat"><i class="fa fa-plus"></i>添加收货地址</button></a>
                </div>
            </div>
        <#if addresses??>
                ...
                <div class="mui-panel">
                    ...
                    <div class="address-operation mui-clearfix">
                        ...
                        <div class="operation-wp">
                            <a href="${basePath}/toupdateAddress.htm?addressId=${address.addressId}&needRetrun=${needRetrun!'0'}"><i class="fa fa-pencil-square-o fa-lg"></i>修改</a>
                            <#if address.isDefault=='1'><#else><a href="${basePath}/delAddress.htm?addressId=${address.addressId}&needRetrun=${needRetrun!'0'}"><i class="fa fa-trash-o fa-lg"></i>删除</a></#if>
                        </div>
                    </div>
                </div>
            </#list>
        ...
        <form id="subForm" method="post">
            ...
            <input type="hidden" name="needRetrun" id="needRetrun" value="${needRetrun!'0'}">
        </form>
        ...
        <script src="${basePath}/js/mui.min.js"></script>
        <script src="${basePath}/js/zepot.min.js"></script>
