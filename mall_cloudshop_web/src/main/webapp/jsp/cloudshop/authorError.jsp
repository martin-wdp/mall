...
<head>
  ...
  <style>
    ...
    .success_info{padding-left:60px;background:url(<%=basePath %>/images/error.png) no-repeat left top;}
...
<div class="success_box">
  <div class="success_info">
    <h4>授权失败！</h4>
    <p><c:if test="${not empty error}">原因：${errot}。</c:if><span class="countdown">5</span>秒自动关闭本页面，请返回qpmall后台稍后重试。</p>
  </div>
